                ...
                <?php  if(is_array($ds)) { foreach($ds as $row) { ?>
                    <tr>
                        ...
                        <td style="text-align:right;">
                            ...
                            <span class="btn  btn-default btn-sm switch <?php  if($row['switch'] == 1) { ?>switchOn<?php  } ?>" data-toggle="tooltip" data-placement="bottom" value="<?php  echo $row['reid'];?>" <?php  if($row['switch'] == 1) { ?>title="开启"<?php  } else { ?>title="关闭"<?php  } ?>></span>
                        </td>
                    </tr>
                <?php  } } ?>
                </tbody>
