...
<form class="form-inline" style="padding-bottom: 20px;" action="" method="post">
    <a class="btn btn-info  btn-danger" href="<?php  echo $this->createWebUrl('ClassifyAction',['type'=>'add'])?>" >添加课程</a>
...
<table class="table table-bordered table-hover">
    <tr>
        ...
        <th class="text-center">主图图片</th>
        <th class="text-center">课程视频</th>
